...
.. _ansible_collections.inspur.sm.add_ldisk_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`inspur.sm.add_ldisk`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Access Policy, 1 - Read Write, 2 - Read Only, 3 - Blocked,Required when <em>Info=None</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Drive Cache, 1 - Unchanged, 2 - Enabled,3 - Disabled,Required when <em>Info=None</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Init State, 1 - No Init, 2 - Quick Init, 3 - Full Init,Required when <em>Info=None</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>IO Policy, 1 - Direct IO, 2 - Cached IO,Required when <em>Info=None</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>RAID Level, 0 - RAID0, 1 - RAID1, 5 - RAID5, 6 - RAID6, 10 - RAID10,Required when <em>Info=None</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Read Policy, 1 - Read Ahead, 2 - No Read Ahead,Required when <em>Info=None</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Select Size, from 1 to 100,Required when <em>Info=None</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Strip Size, 1 - 64k, 2 - 128k, 3 - 256k, 4 - 512k, 5 - 1024k,Required when <em>Info=None</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                        ...
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=integer</span>                                            </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Slot Num,input multiple slotNumber like 0,1,2...,Required when <em>Info=None</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Write Policy, 1 - Write Throgh, 2 - Write Back, 3 - Write caching ok if bad BBU,Required when <em>Info=None</em>.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
